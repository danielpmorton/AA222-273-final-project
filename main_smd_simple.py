...
from helpers import seedRNG, plot_SMD_simple 
...
plot_SMD_simple(time_model.times, sim.xHistory, filtered.muHistory, filtered.sigmaHistory, f"{filtered.filter.__name__} Spring Mass Damper")